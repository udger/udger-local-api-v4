...
public class ParserService implements Serializable {
     ...
     *
     * @param ua           the ua
     * @param udgerRequest the udger request
     * @return the udger ua result
     * @throws SQLException   the SQL exception
     * @throws UdgerException the udger exception
     */
    public UdgerUaResult parseUa(String ua, UdgerUaRequest udgerRequest) throws SQLException, UdgerException {
        UdgerParser parser = null;
        checkPoolStarted();
        try {
            parser = parserPool.borrowParser();
            if (parser != null) {
                if (udgerRequest != null) {
                    return parser.parseUa(udgerRequest);
                } else {
